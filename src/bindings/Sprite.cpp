...
py::array_t<float> pySrcRect(ASGE::GLSprite& sprite)
{
  auto length = 4;
  py::capsule free_when_done(
    sprite.srcRect(), [](void* /*data*/) { Logging::TRACE("destroying capsule"); });

  py::array_t<float> out{ { length }, { sizeof(float) }, sprite.srcRect(), free_when_done };
  return out;
}

void pySrcRect2(ASGE::GLSprite& sprite, const py::array_t<float, 4>& array)
{
...
void initSprite(py::module_ & module)
{
  ...
  // ----------------------------------------------------
  py::class_<ASGE::GLSprite> asge_sprite(module, "Sprite", py::is_final(),
  ...
  py::enum_<ASGE::Sprite::FlipFlags>(asge_sprite, "FlipFlags",
    ...
    .value("NORMAL", ASGE::Sprite::FlipFlags::NORMAL, "Texture is not flipped.")
    .value("FLIP_X", ASGE::Sprite::FlipFlags::FLIP_X, "Texture is flipped on the x axis.")
    .value("FLIP_Y", ASGE::Sprite::FlipFlags::FLIP_Y, "Texture is flipped on the y axis.")
    .value("FLIP_BOTH", ASGE::Sprite::FlipFlags::FLIP_BOTH, "Texture is flipped on both axis.");

  py::enum_<ASGE::Sprite::SourceRectIndex>(asge_sprite, "SourceRectIndex",
    ...
    .value("START_X", ASGE::Sprite::SourceRectIndex::SRC_START_X, "Starting point on the x axis")
    .value("START_Y", ASGE::Sprite::SourceRectIndex::SRC_START_Y, "Starting point on the y axis")
    .value("LENGTH_X", ASGE::Sprite::SourceRectIndex::SRC_LENGTH_X, "The length on the x axis")
    .value("LENGTH_Y", ASGE::Sprite::SourceRectIndex::SRC_LENGTH_Y, "The length on the y axis");

    asge_sprite.def("__repr__",
     [](const ASGE::GLSprite& sprite)
     {
       //nolint
       std::stringstream ss;
    ...
    asge_sprite.def("__str__",
     [](const ASGE::GLSprite& sprite) {
       return "ASGE Sprite: (xpos=" + std::to_string(sprite.xPos()) + ")";
     });

  asge_sprite.def_property("src_rect", &pySrcRect, &pySrcRect2,
    R"(
  ...
  asge_sprite.def_property(
    ...
    [](ASGE::GLSprite& self, int8_t z_order) {  self.setGlobalZOrder(z_order); },
    R"(
  ...
  asge_sprite.def_property(
    ...
    static_cast<void  (ASGE::GLSprite::*)(float)     >(&ASGE::GLSprite::opacity),
    R"(
  ...
  asge_sprite.def_property(
    ...
    static_cast<void  (ASGE::GLSprite::*)(float)     >(&ASGE::GLSprite::xPos),
    R"(
  ...
  asge_sprite.def_property(
    ...
    static_cast<void  (ASGE::GLSprite::*)(float)     >(&ASGE::GLSprite::yPos),
    R"(
  ...
  asge_sprite.def_property(
    ...
    static_cast<void  (ASGE::GLSprite::*)(float)     >(&ASGE::GLSprite::width),
    R"(
  ...
  asge_sprite.def_property(
    ...
    static_cast<void  (ASGE::GLSprite::*)(float)     >(&ASGE::GLSprite::height),
    R"(
  ...
  asge_sprite.def_property(
    ...
    static_cast<void  (ASGE::GLSprite::*)(float)     >(&ASGE::GLSprite::scale),
    R"(
  ...
  asge_sprite.def_property(
    "shader",
    [](const ASGE::GLSprite& self) { return dynamic_cast<const ASGE::SHADER_LIB::GLShader*>(self.getPixelShader()); },
    [](ASGE::GLSprite& self, ASGE::SHADER_LIB::GLShader* shader) { self.setPixelShader(shader); },
    R"(
    Example
    -------
  ...
  asge_sprite.def_property(
    "flip_flags",
    static_cast<ASGE::GLSprite::FlipFlags (ASGE::GLSprite::*)(void )const>(&ASGE::GLSprite::flipFlags),
    static_cast<void  (ASGE::GLSprite::*)(ASGE::GLSprite::FlipFlags)     >(&ASGE::GLSprite::setFlipFlags),
    R"(
  ...
  asge_sprite.def_property(
    ...
    static_cast<void  (ASGE::GLSprite::*)(ASGE::Colour)     >(&ASGE::GLSprite::colour),
    R"(
  ...
  asge_sprite.def(
      "isFlippedOnX",
      [](const ASGE::GLSprite &self) { return self.isFlippedOnX(); },
    R"(
  ...
  asge_sprite.def(
      "isFlippedOnY",
      [](const ASGE::GLSprite &self) { return self.isFlippedOnY(); },
    R"(
  ...
  asge_sprite.def(
    "getLocalBounds", [](ASGE::GLSprite& self) { return self.getLocalBounds(); },
    R"(
  ...
  asge_sprite.def(
    "getWorldBounds", [](ASGE::GLSprite& self) { return self.getWorldBounds(); },
    R"(
  ...
  asge_sprite.def(
    "setMagFilter",
    [](ASGE::GLSprite& self, ASGE::Texture2D::MagFilter filter) { self.setMagFilter(filter); },
    py::arg("magfilter"),
    R"(
  ...
  asge_sprite.def(
    "attach",
    [](ASGE::GLSprite& sprite, ASGE::GLTexture* texture) { return sprite.attach(texture); },
    py::arg("texture"),
    R"(
  ...
  asge_sprite.def(
    "loadTexture", &ASGE::GLSprite::loadTexture,py::arg("filename"),
    R"(
